...
const uint8_t devParam[] PROGMEM = {
	...
	0x00, 0xA9,                              // model ID, describes HM hardware. we should use high values due to HM starts from 0
	...
	0xAA, 0xAA, 0xAA                         // The HM-ID 3 bytes, needed for pairing     (Default for flash tool)
};
